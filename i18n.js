const translationDefinitions = {
  ...
  zh: {
    ...
    help: {
      ...
      whatIsBizTrackText: "BizTrack 是一款面向小型企业主的业务管理工具。它将产品管理、订单跟踪和财务管理整合在一个平台中，帮助你更轻松地处理日常业务。",
      ...
      exportToCSVText: "点击“导出 CSV”即可下载业务数据备份。",
      helpClosingText: "BizTrack 的目标是直观、易用，并适合日常业务管理需求。",
      contactPrompt: "如果你有问题、反馈，或想进一步联系，欢迎随时联系！",
    },
    about: {
      codingJourney: "我的编程旅程",
      aboutIntroTitle: "你好，我是 Sumayyah！",
      aboutIntroText: "欢迎来到我的网络角落。在这里，我正认真学习编程。我不是传统意义上的技术专家，而是一位在创业过程中学习如何用代码解决问题的小企业主。",
      ...
      aboutCoachThanks: "我很感谢我的编程导师 Sam Russell 在学习过程中的指导。",
...
function applyTranslatedText(element, translatedText) {
  ...
  if (directBoldChild) {
    ...
    const separatorMatch = translatedText.match(/^(.+?[：:])\s*(.*)$/);
