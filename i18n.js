const translationDefinitions = {
  en: {
    ...
    dashboard: {
      ...
      quickActionsDesc: "Quickly add new business records from the dashboard.",
  ...
  zh: {
    ...
    dashboard: {
      ...
      quickActions: "快捷操作",
      quickActionsDesc: "从仪表盘快速添加新的业务记录。",
      recentActivity: "最近记录",
...
Object.assign(translations.en, {
  ...
  languagePreferenceDesc: "Use the existing EN / CN language toggle in the page header.",
  themePreference: "Theme",
  themePreferenceDesc: "BizTrack currently uses the default dark sidebar and warm dashboard theme.",
...
Object.assign(translations.zh, {
  ...
  languagePreferenceDesc: "请使用页面顶部现有的 EN / CN 语言切换按钮。",
  themePreference: "主题",
  themePreferenceDesc: "BizTrack 当前使用默认的深色侧边栏和暖色仪表盘主题。",
